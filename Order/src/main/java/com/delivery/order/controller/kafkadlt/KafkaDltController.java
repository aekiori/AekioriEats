package com.delivery.order.controller.kafkadlt;
...
import com.delivery.order.service.kafkadlt.KafkaDltService;
...
public class KafkaDltController {
    ...
    @Value("${order.internal.api-key:order-internal-dev-key}")
