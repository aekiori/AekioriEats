package com.delivery.order.service.kafkadlt;

import com.delivery.order.dto.request.KafkaDltReadRequestDto;
import com.delivery.order.dto.request.KafkaDltReplayRequestDto;
import com.delivery.order.dto.response.KafkaDltHeaderResponseDto;
import com.delivery.order.dto.response.KafkaDltMessageResponseDto;
import com.delivery.order.dto.response.KafkaDltReplayResponseDto;
...
public class KafkaDltService {
    ...
    private KafkaConsumer<String, String> newConsumer() {
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, "order-dlt-admin-" + UUID.randomUUID());
