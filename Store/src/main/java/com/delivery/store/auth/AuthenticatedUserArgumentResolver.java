...
import com.delivery.store.service.store.StoreAuthorizationService;
...
public class AuthenticatedUserArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(
        ...
        long userId = storeAuthorizationService.parseAuthenticatedUserId(webRequest.getHeader(USER_ID_HEADER));
