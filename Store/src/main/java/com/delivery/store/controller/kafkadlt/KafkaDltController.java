package com.delivery.store.controller.kafkadlt;
...
import com.delivery.store.service.kafkadlt.KafkaDltService;
...
public class KafkaDltController {
    ...
    @Value("${store.internal.api-key:store-internal-dev-key}")
