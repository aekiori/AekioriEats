package com.delivery.store.service.kafkadlt;

import com.delivery.store.dto.request.KafkaDltReadRequestDto;
import com.delivery.store.dto.request.KafkaDltReplayRequestDto;
import com.delivery.store.dto.response.KafkaDltHeaderResponseDto;
import com.delivery.store.dto.response.KafkaDltMessageResponseDto;
import com.delivery.store.dto.response.KafkaDltReplayResponseDto;
...
public class KafkaDltService {
    ...
    private KafkaConsumer<String, String> newConsumer() {
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, "store-dlt-admin-" + UUID.randomUUID());
