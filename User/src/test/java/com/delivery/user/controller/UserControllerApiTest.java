...
class UserControllerApiTest {
    ...
    void get_user_api_returns_200_for_owner() throws Exception {
        CreateUserResultDto createdUser = userService.createUser(new CreateUserDto("owner@example.com"));
    ...
    void get_user_api_returns_403_when_request_user_is_not_owner() throws Exception {
        CreateUserResultDto createdUser = userService.createUser(new CreateUserDto("owner2@example.com"));
    ...
    void get_user_api_returns_401_when_principal_header_is_missing() throws Exception {
        CreateUserResultDto createdUser = userService.createUser(new CreateUserDto("owner3@example.com"));
    ...
    void update_user_status_api_returns_403_when_request_user_is_not_owner() throws Exception {
        CreateUserResultDto createdUser = userService.createUser(new CreateUserDto("owner4@example.com"));
