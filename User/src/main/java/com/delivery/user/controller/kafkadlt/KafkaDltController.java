package com.delivery.user.controller.kafkadlt;
...
import com.delivery.user.service.kafkadlt.KafkaDltService;
...
public class KafkaDltController {
    ...
    @Value("${user.internal.api-key:user-internal-dev-key}")
