package com.delivery.point.service.kafkadlt;
...
import com.delivery.point.dto.response.KafkaDltHeaderResponseDto;
...
public class KafkaDltService {
    ...
    private KafkaConsumer<String, String> newConsumer() {
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, "point-dlt-admin-" + UUID.randomUUID());
