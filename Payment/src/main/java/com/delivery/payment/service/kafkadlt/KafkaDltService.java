package com.delivery.payment.service.kafkadlt;

import com.delivery.payment.dto.request.KafkaDltReadRequestDto;
import com.delivery.payment.dto.request.KafkaDltReplayRequestDto;
import com.delivery.payment.dto.response.KafkaDltHeaderResponseDto;
import com.delivery.payment.dto.response.KafkaDltMessageResponseDto;
import com.delivery.payment.dto.response.KafkaDltReplayResponseDto;
...
public class KafkaDltService {
    ...
    public KafkaDltReplayResponseDto replay(KafkaDltReplayRequestDto request) {
        ...
        return new KafkaDltReplayResponseDto(request.topic(), request.partition(), request.offset(), targetTopic, record.key());
    }
    ...
    private KafkaConsumer<String, String> newConsumer() {
        ...
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, "payment-dlt-admin-" + UUID.randomUUID());
