...
import com.delivery.payment.service.payment.PaymentAuthorizationService;
...
public class AuthenticatedUserArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(
        ...
        long userId = paymentAuthorizationService.parseAuthenticatedUserId(webRequest.getHeader(USER_ID_HEADER));
