package com.delivery.payment.controller.kafkadlt;
...
import com.delivery.payment.service.kafkadlt.KafkaDltService;
...
public class KafkaDltController {
    ...
    @Value("${payment.internal.api-key:payment-internal-dev-key}")
